...
<!-- 编者按（2026-07-03，Opus 4.8 归档时补，不属历史正文）：上一行提及的 mother-skill-redraft-workflow.md 已被 KL9 作为技术债清理，不复存在，无需寻找。此为封存的 RINA-Constitutio 前身文本，仅历史留存；现行母本为 apostle-constitutio，改写指引见其 §8 证词账。 -->
